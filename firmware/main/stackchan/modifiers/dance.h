...
public:
     ...
     * - Mouth open
     */
    /** Slower, smaller sway for ambient music reaction. */
    inline static const animation::KeyframeSequence Gentle = {
        {{0, 0, 0, 100}, {0, 0, 0, 100}, {0, 0, 0, 0}, {0, 200}, {0, 200}, 700},
        {{-6, 0, 0, 40}, {-6, 0, 0, 40}, {0, 0, 0, 30}, {180, 180}, {-60, 180}, 1100},
        {{6, 0, 0, 40}, {6, 0, 0, 40}, {0, 0, 0, 30}, {-180, 180}, {-60, 180}, 1100},
        {{-6, 0, 0, 40}, {-6, 0, 0, 40}, {0, 0, 0, 30}, {180, 180}, {-60, 180}, 1100},
        {{0, 0, 0, 100}, {0, 0, 0, 100}, {0, 0, 0, 0}, {0, 200}, {0, 200}, 700},
    };
